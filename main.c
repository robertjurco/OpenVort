...
int main(int argc, char **argv)
{
    ...
    if (load_tangle_from_init) {
		...
		enforce_wall_boundaries(tangle, 0.0); // Goes first in case of vortex initialized outside of the domain.
		...
		remesh(tangle, global_dl_min, global_dl_max, 0.0); // Remesh has to go beforte update_tangle to remove points near each other.
