...
extern double loop_injection_frequency; // Number of loops injected per second (frequency).

// Line pair injection.
extern int line_injection; // Bool, inject or not.
extern int line_injection_n; // How many pairs to inject.
extern double line_injection_frequency; // Number of pairs injected per second (frequency).
extern int line_injection_polarized; // Bool, whether the injection is polarized. Off by default.

// Barnes-Hut tree approximation.
extern int use_BH; // 1 for use of Barnes-Hut tree approximation.
